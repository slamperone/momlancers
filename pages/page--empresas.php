            ...
            <div class="row  align-items-center g-0">
                <div class="col-12 col-md-5">
                    <figure class="hero-img">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/hero-empresa.jpg" alt=""
                            class="img-fluid">
                    </figure>
                </div>
                <div class="col-12 col-md-7 mx-auto">
                    <div class="d-block p-5">
                        ...
                        <p class="fs-5 text-white fw-600">Somos tus aliadas y te ayudaremos a establecer una oportunidad
                            estratégica para apoyar y aprovechar los talentos de las madres trabajadoras, creando un
                        ...
                        <div class="row d-flex h-100">
                            <div class="col-2">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/uno.png" alt=""
                                    class="img-fluid">
                            </div>
                            <div class="col-10 justify-content-center align-self-center text-white fw-400">Atraer
                                talento femenino</div>
                        </div>

                        <div class="row d-flex h-100 my-2">
                            <div class="col-2">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/dos.png" alt=""
                                    class="img-fluid">
                            </div>
                            <div class="col-10 justify-content-center align-self-center text-white fw-400">Impulsar el
                                talento femenino</div>
                        </div>
        ...
        <div class="container-fluid">
            <div class="row my-5 align-items-center">
                ...
                <div class="col-12 col-md-3">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/vector-6.png" alt=""
                        class="img-fluid d-none d-lg-block" style="margin-top: -90px;">
                </div>
            </div>
            <div class="row my-5 align-items-center">
        ...
        <div class="container-fluid">
            ...
            <div class="row ">
                <div class="col-12 col-md-4 ">
					...
					print get_template_part(
						'templates/components/cards/card-style-1',
						null,
						array(
        ...
        <div class="container-fluid">
            <div class="row my-5 align-items-top">
                ...
                <div class="col-12 col-md-3 text-center">
                    <figure class="">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/vector-3.png" alt=""
...
<section class="strap strap-casos strap-carousel-2">
    <div class="inner py-2 py-md-5">
        <div class="container-fluid">
            ...
            <div class="row my-5 align-items-center position-relative">
                <button class="arrow-prev-2 position-absolute w-auto start-0 z-2">
                    <iconify-icon icon="fluent:ios-arrow-24-regular" class="text-color-1" width="3rem" height="3rem">
                    </iconify-icon>
                </button>
                <div class="col-10 ofsset-1 offset-md-0 col-md-8 mx-auto">
                    <div class="owl-carousel owl-style-2 ">
						...
						?>
                        <div class="item p-4">
                            <?php print get_template_part(
										'templates/components/cards/card-style-3',
										null,
										array(
                ...
                <button class="arrow-next-2 position-absolute w-auto end-0 z-2">
                    <iconify-icon icon="fluent:ios-arrow-rtl-24-regular" class="text-color-1" width="3rem"
                        height="3rem"></iconify-icon>
                </button>
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row my-5 align-items-center">
                <div class="col-12 col-md-6">
                    <figure>
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/emp-img-transforma.jpg" alt=""
                            class="img-fluid" />
                    </figure>
                </div>
                <div class="col-12 col-md-6">
                    <article class="p-3">
                        <p>Diseñamos programas personalizados para tu empresa enfocados en empoderar, promover la
                            equidad  e impulsar profesionalmente al talento de madres trabajadoras.</p>
                        <p>​Algunos de nuestros servicios: diagnóstico, coaching individual o grupal, talleres,
                            formación de mentoras dentro de tus empresas.</p>
                    </article>
                </div>
            </div>
        </div>
